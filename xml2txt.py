...
注意1：将此文件放置在yolov5工程文件夹下的根目录下即可，不是放在data目录里面
注意2：就改动   类似     # *****   XXX****的地方，的路径即可，当然数据集划分比例也可以改成0.8-0.1-0.1
"""
...
xml_file_path = 'data/xml/'       # *********检查和自己的xml文件夹名称是否一致*********
images_file_path = 'data/images/'  # *******检查和自己的图像文件夹名称是否一致********
